            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">{{ $theme->name }} - mavzusi audiolari</h5>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        @foreach($audios as $id => $item)
                            <tr>
                                <td>{{ $id+1 }}</td>
                                <td>
                                    <audio controls>
                                        <source src="{{ asset('audio') }}/{{ $item->name }}" >
                                        Your browser does not support the audio element.
                                    </audio>
                                </td>
                                <td>
                                    <a href="{{ route('admin.audio.delete', ['id' => $item->id]) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            <form action="{{ route('admin.audio.add') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <label class="form-label">Audio <span class="text-danger">*</span></label>
                                <input name="audio" required type="file" class="form-control mb-3" placeholder="">
